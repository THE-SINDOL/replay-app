...
export const RESOURCES_PATH = APP_PATH.endsWith("app.asar")
  ...
  : path.join(APP_PATH.split("build")[0], ".."); // Otherwise everything is in the root of the app
export const mainAppIconDevPng = nativeImage.createFromPath(path.join(RESOURCES_PATH, "assets", "icon@2x.png"));
